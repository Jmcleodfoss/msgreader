...
public class Debug {
	...
	/** Get a logger. This is a wrapper around java.utilo.logging.Logger.getLogger(); using it to obtains logger ensures that packageLogger is appropriately initialized.
